...
#include "../Resources/bin/logo_png.c"
	ICE_GLOBJ_RESOURCES.texture_logo = ICE_Texture_LoadFromFile_RW(SDL_RWFromConstMem((void*)ICE_Resource_logo_png, ICE_Resource_logo_png_length));
}
...
#include "../Resources/bin/err1024_png.c"
		ICE_GLOBJ_RESOURCES.texture_error = ICE_Texture_LoadFromFile_RW(SDL_RWFromConstMem((void*)ICE_Resource_err1024_png, ICE_Resource_err1024_png_length));
	}
	else
	{
#include "../Resources/bin/err512_png.c"
		ICE_GLOBJ_RESOURCES.texture_error = ICE_Texture_LoadFromFile_RW(SDL_RWFromConstMem((void*)ICE_Resource_err512_png, ICE_Resource_err512_png_length));
	}
}
...
#include "../Resources/bin/gui27_png.c"
	ICE_GLOBJ_RESOURCES.texture_gui_default = ICE_Texture_LoadFromFile_RW(SDL_RWFromConstMem((void*)ICE_Resource_gui27_png, ICE_Resource_gui27_png_length));
}
...
#include "../Resources/bin/font_ttf.c"
	ICE_GLOBJ_RESOURCES.font_default = ICE_Font_Load_RW(SDL_RWFromConstMem((void*)ICE_Resource_font_ttf, ICE_Resource_font_ttf_length));
}
